...
void UART_Init(void){
  ...
  UART0_IBRD_R = 43;                    // IBRD = int(80,000,000 / (16 * 115,200)) = int(43.2278)
  UART0_FBRD_R = 26;                     // FBRD = int(0.2278 * 64 + 0.5) = 26
  ...
  GPIO_PORTA_AMSEL_R = 0;               // disable analog functionality on PA
                                        // UART0=priority 2
  NVIC_PRI1_R = (NVIC_PRI1_R&0xFFFF00FF)|0x0000A000; // bits 13-15
